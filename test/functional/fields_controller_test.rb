...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { instructions: @field.instructions, label_text: @field.label_text, name: @field.name, type: @field.type }
    end
  ...
  test "should update field" do
    put :update, id: @field, field: { instructions: @field.instructions, label_text: @field.label_text, name: @field.name, type: @field.type }
    assert_redirected_to field_path(assigns(:field))
  end
